...
To use these stylesheets, rename the files and traintheater with the name of your theme.
...
traintheater-alpha-default.css
...
traintheater-alpha-default-narrow.css  
...
traintheater-alpha-default-normal.css
...
traintheater-alpha-default-wide.css
